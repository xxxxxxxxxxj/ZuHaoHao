    ...
    public void asyncGetImage(String object) {
        ...
        get.setProgressListener(new OSSProgressCallback<GetObjectRequest>() {
            ...
            public void onProgress(GetObjectRequest request, long currentSize, long totalSize) {
                ...
                Log.d("GetObject", "currentSize: " + currentSize + " totalSize: " + totalSize + " progress: " + progress);
            }
        });
    ...
    public void customSign(Context ctx, String objectKey) {
        OSSCustomSignerCredentialProvider provider = new OSSCustomSignerCredentialProvider() {
            ...
            public String signContent(String content) {
                ...
                String signedString = OSSUtils.sign(AppConfig.OSS_ACCESS_KEY_ID, AppConfig.OSS_ACCESS_KEY_SECRET, content);
                return signedString;
            }
        };
